...
<footer class="footer-section">
    <div class="container">
        <div class="row" style="padding-bottom: 40px;">
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>Subashitha Fashion</span>
                        </a>
                    </div>
                    <ul>
                        <li>+91 9449738855</li>
                        <li>subashithafashion@gmail.com</li>
                        <li>Nehru Road, Shivamogga</li>
                    </ul>
                    <div class="footer-social">
                        <a href="https://www.facebook.com/" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://www.instagram.com/?hl=en" target="_blank"><i class="fa fa-instagram"></i></a>
                        <a href="https://whatsapp.com/explore" target="_blank"><i class="fa fa-whatsapp"></i></a>
            ...
            <div class="col-lg-4">
                <div class="newslatter-item">
                    <h5>Our Student Developers</h5>
                    <p>Harshitha V and Nisarga M 
                                Department of Artificial Intelligence and Machine Learning, PES Institute of Technology and Management,Shimoga</p>
                </div>
            </div>
        </div>
    </div>
