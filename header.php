...
<meta charset="UTF-8">
<meta name="description" content="Subashitha Fashion">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Subashitha Fashion</title>
...
<?php
// PHP script handling the search functionality
if (isset($_POST['submit'])) {
    // Get the search query from the form
    $item = $_POST["search"];

    // Construct the SQL query to search for the product
    ...
    // If a product is found, redirect to the product page
    if ($count > 0) {
